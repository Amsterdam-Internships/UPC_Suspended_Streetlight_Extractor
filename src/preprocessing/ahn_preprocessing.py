...
def clip_ahn_las_folder(ahn_cloud, in_folder, out_folder=None, buffer=1,
                        resume=False, hide_progress=False, prefix='filtered_'):
    """
...
def process_ahn_las_tile(ahn_las_file, out_folder='', resolution=0.1):
    ...
    ground_surface = _get_ahn_surface(ahn_las, grid_x, grid_y, 'idw',
                                      AHN_GROUND)
    artifact_surface = _get_ahn_surface(ahn_las, grid_x, grid_y, 'idw',
                                      AHN_ARTIFACT)                                  
