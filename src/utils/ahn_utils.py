...
def load_ahn_tile(ahn_file):
    ...
    return the results as a dict with keys 'x', 'y', 'ground_surface',
    'artifact_surface' and 'building_surface'.
    """
    ...
    if 'artifact' in ahn.keys():
        ahn_tile['artifact_surface'] = ahn['artifact'].astype(float)
